...
技書博副代表の水殿です。本章では「技書博を支える技術」というテーマで、技書博1で主に担当していた設営・撤収の裏話をお伝えしたいと思います。なお、机などの配置を決めるための作業を@<strong>{測量}、机・椅子など配置する物を並べる作業を@<strong>{設営}、閉会後に机・椅子・その他会場から配送する本・機材などを片付ける作業を@<strong>{撤収}という名称で進めたいと思います。
